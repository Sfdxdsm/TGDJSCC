...
from models_global_branch import Net
...
def get_args_parser():
    ...
    # Dataset
    parser.add_argument('--trainset', type=str, default='cifar100', choices=['cifar100', 'imagenet'])
    parser.add_argument('--testset', type=str, default='cifar100', choices=['cifar100', 'cifar10'])
...
def main(args):
    ...
    encoder = models_global_branch.__dict__[args.encoder](C=args.C, selected_nodes_num=args.selected_nodes_num,window_size=args.window_size,
    ...
    if args.finetune and args.training:
        ...
        for key in checkpoint_model.keys():
            if key.startswith('DS_list') or key.startswith('select_blocks'):
    ...
    decoder = models_global_branch.__dict__[args.decoder](C=args.C, selected_nodes_num=args.selected_nodes_num)
